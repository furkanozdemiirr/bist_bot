...
BIST100 = list(dict.fromkeys([
    "AEFES", "AGESA", "AGHOL", "AGROT", "AHGAZ", "AKBNK", "AKCNS", "AKGRT", "AKSA", "AKSEN", 
    "ALARK", "ALBRK", "ALFAS", "ALTNY", "ANHYT", "ANSGR", "ARCLK", "ARDYZ", "ASELS", "ASTOR", 
    "AVGYO", "AVPGY", "AYDEM", "BALSU", "BERA", "BIMAS", "BRSAN", "BRYAT", "BTCIM", "BUCIM", 
    "CCOLA", "CIMSA", "CWENE", "DOAS", "DOHOL", "DSTKF", "DYNMO", "ECILC", "EKGYO", "ENJSA", 
    "ENKAI", "EREGL", "FENER", "FROTO", "GARAN", "GENIL", "GESAN", "GLYHO", "GUBRF", "GWIND", 
    "HALKB", "HEKTS", "ISCTR", "ISDMR", "ISGYO", "KARSN", "KCHOL", "KONTR", "KONYA", "KORDS", 
    "KOZAA", "KOZAL", "KRDMD", "LOGO", "MAVI", "MGROS", "MPARK", "NETAS", "ODAS", "OTKAR", 
    "OYAKC", "PAHOL", "PASEU", "PETKM", "PGSUS", "POLHO", "SAHOL", "SASA", "SISE", "SKBNK", 
    "SOKM", "TAVHL", "TCELL", "THYAO", "TKFEN", "TOASO", "TRALT", "TTKOM", "TTRAK", "TUPRS", 
